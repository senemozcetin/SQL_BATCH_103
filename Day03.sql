...
DELETE FROM ogrenciler9 WHERE isim='Mustafa Bak' and isim='Nesibe Yilmaz';

-- TRUNCATE -- 
-- Bir tablodaki tüm verileri geri alamayacağımız şekilde siler. Şartlı silme yapmaz

TRUNCATE ogrenciler9
...
CONSTAINT not1_fk FOREIGN KEY(talebeler_id) REFERENCES talebeler(id)
on delete cascade
);
